...
format = TestList [  
(TestLabel "MOVE FORMAT WRONG!" (TestCase (assertFormat (CannonBot.getMove "4W5/1w1w1w1w1w/1w1w1w1w1w/1w1w1w1w1w///b1b1b1b1b1/b1b1b1b1b1/b1b1b1b1b1/7B2 w") formatMove))),
